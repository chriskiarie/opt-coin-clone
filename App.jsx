    ...
    <div className="px-4">
      <div className="relative rounded-2xl overflow-hidden aspect-[16/9] bg-black border border-gray-800 shadow-2xl">
        ...
        <div className="absolute inset-0 p-8 flex flex-col justify-center">
          <h2 className="text-4xl font-bold text-white tracking-widest italic">OPT COIN</h2>
  ...
  <div className="pb-32 px-4 pt-6">
    ...
    <div className="grid grid-cols-12 gap-4">
      <div className="col-span-7 space-y-4">
        ...
        <button className="w-full py-4 bg-green-500 text-black font-black rounded-xl">Open Long</button>
      </div>
    ...
    <div className="space-y-6">
      {[
        ...
        <div key={coin.id} className="flex justify-between items-center">
          ...
          <div className={`w-[90px] ${coin.positive ? 'bg-[#22c55e]' : 'bg-[#ef4444]'} text-white py-2 rounded-lg font-black text-xs text-center shadow-lg`}>
            {coin.change}%
          </div>
        </div>
      ))}
...
const Navbar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#1a1c22] border-t border-gray-800 flex justify-around items-center pt-2 pb-6 px-1 z-50 shadow-2xl">
      {tabs.map((tab) => {
